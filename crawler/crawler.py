...
if __name__ == '__main__':
    ...
    for link in soup:
        ...
        if isinstance(link.get('href'), str):
            ...
            json_set_function[func_name] = func_obj
    ...
    for res in soup:
        ...
        res_obj = {
            "prefix": res_name,
            "body": [res_name, "@"+res_name],
            "description": "resources"
        }
        res_name = "@"+res_name
        json_set_resources[res_name] = res_obj
        res_obj = {
            "prefix": res_name,
            "body": res_name,
            "description": "resources"
    ...
    for color in color_soups:
        ...
        json_set_color_table[color_name] = color_obj
        print("color: {:<40s}{:<}".format(color_name, "done."))

    # write
    write_to_file(json_set_function, "../snippets/function.json")
    write_to_file(json_set_resources, "../snippets/resources.json")
    write_to_file(json_set_color_table, "../snippets/color_table.json")
